...
dbLoadRecords("db/iocAdminRTEMS.db", "IOC=IOC:UND1:UC02")
dbLoadRecords("db/iocRelease.db", "IOC=IOC:UND1:UC02")

## Load motor records
dbLoadRecords("db/xxCamAsynMotor.vdb","U=USEG:UND1:250,M=CM1,MDESC=CAM 1,PORT=S0,ADDR=0")
dbLoadRecords("db/xxCamAsynMotor.vdb","U=USEG:UND1:250,M=CM2,MDESC=CAM 2,PORT=S1,ADDR=0")
dbLoadRecords("db/xxCamAsynMotor.vdb","U=USEG:UND1:250,M=CM3,MDESC=CAM 3,PORT=S2,ADDR=0")
dbLoadRecords("db/xxCamAsynMotor.vdb","U=USEG:UND1:250,M=CM4,MDESC=CAM 4,PORT=S3,ADDR=0")
dbLoadRecords("db/xxCamAsynMotor.vdb","U=USEG:UND1:250,M=CM5,MDESC=CAM 5,PORT=S4,ADDR=0")

## extra records for smart motor stats, TEMP, TORQUE, FW
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=CM1,PORT=S0,ADDR=0")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=CM2,PORT=S1,ADDR=0")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=CM3,PORT=S2,ADDR=0")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=CM4,PORT=S3,ADDR=0")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=CM5,PORT=S4,ADDR=0")

#####################(Marty Smith)############################
dbLoadRecords("db/HGVPU.db","U=USEG:UND1:250")
#dbLoadRecords("db/HGVPUmotors.db","U=USEG:UND1:250,S=0.773,MH=50.0,ML=3.5,PORT=S7,ADDR=0,IDMOTOR=USW,MDESC=USW")
#dbLoadRecords("db/HGVPUmotors.db","U=USEG:UND1:250,S=0.773,MH=50.0,ML=3.5,PORT=S7,ADDR=1,IDMOTOR=USA,MDESC=USA")
#dbLoadRecords("db/HGVPUmotors.db","U=USEG:UND1:250,S=0.773,MH=50.0,ML=3.5,PORT=S7,ADDR=2,IDMOTOR=DSW,MDESC=DSW")
#dbLoadRecords("db/HGVPUmotors.db","U=USEG:UND1:250,S=0.773,MH=50.0,ML=3.5,PORT=S7,ADDR=3,IDMOTOR=DSA,MDESC=DSA")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=USW,PORT=S7,ADDR=0")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=USA,PORT=S7,ADDR=1")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=DSW,PORT=S7,ADDR=2")
dbLoadRecords("db/smart_extra.db","P=USEG:UND1:250:,M=DSA,PORT=S7,ADDR=3")
dbLoadRecords("db/IDcommon_NewPower.db","U=USEG:UND1:250,DH=100.0,DL=7.18,BL=7.19")
dbLoadRecords("db/IDLimitSwitches.db","U=USEG:UND1:250,PORT=limits,PORT1=internalIO")

dbLoadRecords("db/IDmotion.db","U=USEG:UND1:250,S=5.0,PORT=idmon")
dbLoadRecords("db/IDMonitors.db","U=USEG:UND1:250,PORT=idmon,PORT1=monitors")
dbLoadRecords("db/IDerrors.db","U=USEG:UND1:250")
dbLoadRecords("db/ID_FPGArev.db","U=USEG:UND1:250")
dbLoadRecords("db/FagorEncoders.db","U=USEG:UND1:250")

dbLoadRecords("db/HGVPU_coordMotion.db","U=USEG:UND1:250")
#####################(Marty Smith)############################

## Load database for Cam Motion
dbLoadRecords("db/xxCamMotion.vdb","U=USEG:UND1:250, UND=U02")

## Load database for Linear Motion
dbLoadRecords("db/xxLinearMotion.vdb","U=USEG:UND1:250,PORT=ai1, UND=U02, kmax=16")
...
dbLoadRecords("db/tews_LinearSSI.db","U=USEG:UND1:250,PORT=LinEnc,L1=103.8174,L2=102.0518,L3=102.1204,L4=99.4575")
...
#!dbLoadRecords("db/undulatorRTD.db","U=USEG:UND1:250,PORT=ai1")
#!dbLoadRecords("db/xxUndulatorRTD.vdb","U=USEG:UND1:250")

## Load databases for undulator smart monitors
#!dbLoadRecords("db/xxUndulatorSmartMon.vdb","U=USEG:UND1:250, B=BFW:UND1:210, PORT1=io8, PORT2=ai1")

## Load databases for calibrating CAMs
dbLoadRecords("db/xxCamCalibration.vdb","U=USEG:UND1:250")

## Load databases for alarm display summaries
dbLoadRecords("db/xxUndulatorDispAlarmSum.db","U=USEG:UND1:250")

## Load databases for automated display options
dbLoadRecords("db/xxUndulatorDisplay.vdb","U=USEG:UND1:250")

## Load databases for Undulator field calculations
dbLoadRecords("db/xxUndulatorField.vdb","U=USEG:UND1:250")
dbLoadRecords("db/useg2-poly.db")
dbLoadRecords("db/useg-poly-bb.db", "U=USEG:UND1:250, POSITION=2")
dbLoadRecords("db/poly-bb-ao.db", "U=USEG:UND1:250")

## Load databases for Undulator BPM and X-YCOR corrections
dbLoadRecords("db/xxBPMCorrection.vdb", "U=USEG:UND1:250")
dbLoadRecords("db/xxCORcorrection.vdb", "U=USEG:UND1:250, UN1=USEG:UND1:350, N=2")

## Load database to save reference motor positions
dbLoadRecords("db/save-reference-position.db", "U=USEG:UND1:250")

## asynRecord database for each link for diagnostic debugging
dbLoadRecords("db/asynRecord.db","P=USEG:UND1:250:ASYN,R=CAM1,PORT=L0,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:UND1:250:ASYN,R=CAM2,PORT=L1,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:UND1:250:ASYN,R=CAM3,PORT=L2,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:UND1:250:ASYN,R=CAM4,PORT=L3,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:UND1:250:ASYN,R=CAM5,PORT=L4,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:UND1:250:ASYN,R=HGU,PORT=L7,ADDR=0,IMAX=0,OMAX=0")

## Load database for autosave/restore status pv's
dbLoadRecords("db/save_restoreStatus.db","P=IOC:UND1:UC02:")

#Load unique items
< iocBoot/ioc-und1-uc02/st-unique.cmd

## autosave/restore settings
save_restoreSet_status_prefix( "IOC:UND1:UC02:")
...
#Load unique items
< iocBoot/ioc-und1-uc02/st-post-unique.cmd
...
create_monitor_set("info_positions.req", 5, "U=USEG:UND1:250, B=BFW:UND1:210")
create_monitor_set("info_settings.req", 30, "U=USEG:UND1:250")

# Let's start up our Sequencers:
seq( &camCal, "S=USEG:UND1:250")
#!seq( &motorMon, "S=USEG:UND1:250")
#!seq( &bfwMon, "B=BFW:UND1:210, S=USEG:UND1:250")
