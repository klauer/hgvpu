...
configTip114("LinEnc",5,30,5,"B","E",0)
# Full-gap Encoder : Downstream
configTip114("LinEnc",6,30,5,"B","E",0)
...
# -------------------------------------------------------------------------
# SmartCreateController(motorPortName,asynPortName,realAxis,virtualAxis,movingPollPeriod,idlePollPeriod,defaultClass)
