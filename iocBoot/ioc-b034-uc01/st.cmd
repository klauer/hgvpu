...
#
# revision history:
#   20-Jan-2008        Arturo Alarcon             initial versiion
#
####################################################################
...
epicsEnvSet("LOCA_NAME", "B034")

# Setup for iocAdmin:
epicsEnvSet("ENGINEER","Arturo Alarcon")
epicsEnvSet("LOCATION","B034-RM208")
# ------------------------------------------------------------------------
...
dbLoadRecords( "db/iocAdmin.db", "IOC=IOC:UND1:UC01")

## Load cater numbers database
dbLoadRecords( "db/xxUndulatorProblems.vdb","U=USEG:B034:150,N=1")
dbLoadRecords( "db/xxUndulatorProblems.vdb","U=USEG:B034:150,N=2")
dbLoadRecords( "db/xxUndulatorProblems.vdb","U=USEG:B034:150,N=3")
dbLoadRecords( "db/xxUndulatorProblems.vdb","U=USEG:B034:150,N=4")

## Load motor records
dbLoadRecords("db/xxCamMotor.vdb","U=USEG:B034:150,M=CM1,MDESC=CAM 1,card=C0,addr=S0")
dbLoadRecords("db/xxCamMotor.vdb","U=USEG:B034:150,M=CM2,MDESC=CAM 2,card=C1,addr=S0")
dbLoadRecords("db/xxCamMotor.vdb","U=USEG:B034:150,M=CM3,MDESC=CAM 3,card=C2,addr=S0")
dbLoadRecords("db/xxCamMotor.vdb","U=USEG:B034:150,M=CM4,MDESC=CAM 4,card=C3,addr=S0")
dbLoadRecords("db/xxCamMotor.vdb","U=USEG:B034:150,M=CM5,MDESC=CAM 5,card=C4,addr=S0")
dbLoadRecords("db/xxTranslationMotor.vdb", "U=USEG:B034:150, M=TM1, MDESC=TM 1,card=C5,addr=S0")
dbLoadRecords("db/xxTranslationMotor.vdb", "U=USEG:B034:150, M=TM2, MDESC=TM 2,card=C6,addr=S0")

## Load database for Cam Motion
dbLoadRecords("db/xxCamMotion.vdb","U=USEG:B034:150, UND=U01")

## Load database for Linear Motion
dbLoadRecords("db/xxLinearMotion.vdb","U=USEG:B034:150,PORT=ai1, UND=U01")

## Load databases for RTD temperature monitors
dbLoadRecords("db/xxUndulatorRTD.vdb","U=USEG:B034:150,PORT=ai1")

## Load databases for BFW actuator control/position monitor
dbLoadRecords("db/xxUndulatorBFWact.vdb","B=BFW:B034:110, PORT=io8")

## Load databases for undulator smart monitors
dbLoadRecords("db/xxUndulatorSmartMon.vdb","U=USEG:B034:150, B=BFW:B034:110, PORT1=io8, PORT2=ai1")

## Load databases for calibrating CAMs
dbLoadRecords("db/xxCamCalibration.vdb","U=USEG:B034:150")

## Load databases for alarm display summaries
dbLoadRecords("db/xxUndulatorDispAlarmSum.vdb","U=USEG:B034:150, B=BFW:B034:110")

## Load databases for Undulator field calculations
dbLoadRecords("db/xxUndulatorField.vdb","U=USEG:B034:150")
dbLoadRecords("db/useg1-poly.db")

## asynRecord database for each link for diagnostic debugging
dbLoadRecords("db/asynRecord.db","P=USEG:B034:150:ASYN,R=CAM1,PORT=L0,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:B034:150:ASYN,R=CAM2,PORT=L1,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:B034:150:ASYN,R=CAM3,PORT=L2,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:B034:150:ASYN,R=CAM4,PORT=L3,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:B034:150:ASYN,R=CAM5,PORT=L4,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:B034:150:ASYN,R=TRA1,PORT=L5,ADDR=0,IMAX=0,OMAX=0")
dbLoadRecords("db/asynRecord.db","P=USEG:B034:150:ASYN,R=TRA2,PORT=L6,ADDR=0,IMAX=0,OMAX=0")

## Load database for autosave/restore status pv's
dbLoadRecords("db/save_restoreStatus.db","P=IOC:B034:UC01:")

## autosave/restore settings
save_restoreSet_status_prefix( "IOC:B034:UC01:")
...
create_monitor_set("info_positions.req", 5, "U=USEG:B034:150, B=BFW:B034:110")
create_monitor_set("info_settings.req", 30, "U=USEG:B034:150")

# Let's start up our Sequencers:
seq( &camCal, "S=USEG:B034:150")
seq( &motorMon, "S=USEG:B034:150")
seq( &bfwMon, "B=BFW:B034:110, S=USEG:B034:150")
# seq( &recovery, "S=USEG:B034:150")

# Process KDES with temp correction restored
dbpf("USEG:B034:150:KDES.PROC","1")
