	...
	int risingMask, int fallingMask)
{
	...
	/* The data direction register is set up in blocks of 8 bits due to the
	   hardware on the IP_EP201 ... each driver controls direction for 8-bits.
 	   With this version of the driver bit zero sets direction for the lower
           8-bits (of 16) and bit 8 sets the direction for the upper 8-bits  
        */
